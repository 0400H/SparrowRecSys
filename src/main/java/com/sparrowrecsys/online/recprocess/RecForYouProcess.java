...
import static sparrowrecsys.online.util.HttpClient.asyncSinglePostRequest;
...
public class RecForYouProcess {
    ...
    public static void callWideDeepTFServing(User user, List<Movie> candidates, HashMap<Movie, Double> candidateScoreMap){
        ...
        String predictURL = Config.TF_SERVING_URL_PREFIX_WIDE_DEEP + modelVersion + ":predict";
        System.out.println("Predict url: " + predictURL);

        //need to confirm the tf serving end point
        String predictionScores = asyncSinglePostRequest(predictURL, instancesRoot.toString());
