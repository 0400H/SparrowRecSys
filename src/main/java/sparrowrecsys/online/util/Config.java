...
public class Config {
    ...
    public static String MYSQL_DB_CONNECTION_URL =
            "jdbc:mysql://sparrow-recsys:3306/sparrow_recsys?" +
            "user=root&password=123456&autoReconnect=true";

    public static String REDIS_SERVER = "sparrow-recsys";
    public static String REDIS_PASSWORD = "123456";
    public static int REDIS_PORT = 6379;

    public static String KAFKA_BROKER_SERVERS = "sparrow-recsys:9092";
    public static String HDFS_PATH_ALL_MOVIES = "hdfs://sparrow-recsys:8020/sparrow_recsys/movies/";
    public static String HDFS_PATH_ALL_RATINGS = "hdfs://sparrow-recsys:8020/sparrow_recsys/ratings/";
    public static String HDFS_PATH_SAMPLE_DATA = "hdfs://sparrow-recsys:8020/sparrow_recsys/sampledata/";
    public static String HDFS_PATH_MODEL_DATA = "hdfs://sparrow-recsys:8020/sparrow_recsys/modeldata/";
    public static String HDFS_PATH_ALL_MOVIE_EMBEDDINGS = "hdfs://sparrow-recsys:8020/sparrow_recsys/movie-embeddings/";

    public static String TF_SERVING_URL_PREFIX_WIDE_DEEP =
            "http://sparrow-recsys:8501/v1/models/sparrow_recsys_widedeep";
